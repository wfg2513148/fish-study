...
- 家长答案页：`outputs/YYYY-MM-DD/wrong-question-training-answers.pdf`
- 分学科学生训练卷：`outputs/YYYY-MM-DD/math-training.pdf`、`science-training.pdf`、`english-training.pdf`
- 分学科答案页：`outputs/YYYY-MM-DD/math-training-answers.pdf`、`science-training-answers.pdf`、`english-training-answers.pdf`
...
outputs/YYYY-MM-DD/weekly-review.pdf
outputs/YYYY-MM-DD/weekly-review-answers.pdf
...
```text
outputs/YYYY-MM-DD/wrong-question-training.pdf
outputs/YYYY-MM-DD/weekly-review.pdf
outputs/YYYY-MM-DD/math-training.pdf
outputs/YYYY-MM-DD/science-training.pdf
outputs/YYYY-MM-DD/english-training.pdf
```
...
```text
outputs/YYYY-MM-DD/wrong-question-training-answers.pdf
outputs/YYYY-MM-DD/weekly-review-answers.pdf
outputs/YYYY-MM-DD/math-training-answers.pdf
outputs/YYYY-MM-DD/science-training-answers.pdf
outputs/YYYY-MM-DD/english-training-answers.pdf
```
